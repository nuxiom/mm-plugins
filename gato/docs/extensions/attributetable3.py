...
def visit_attributetable_node(self: DPYHTML5Translator, node: attributetable) -> None:
    ...
    self.body.append(f'<div style="display: flex" class="py-attribute-table" data-move-to-id="{class_}">')


def visit_attributetablecolumn_node(self: DPYHTML5Translator, node: attributetablecolumn) -> None:
    self.body.append(self.starttag(node, 'div', CLASS='py-attribute-table-column', STYLE='margin-right: 20px;'))
